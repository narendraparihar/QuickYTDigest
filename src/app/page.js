...
const Home = () => {
  ...
  const aiFacts = [
    ...
    "AI-powered virtual assistants, like Siri and Alexa, are becoming more common in households.",
    "AI can translate languages in real-time, breaking down communication barriers.",
    "AI is being used to create realistic virtual worlds in video games.",
    "AI can predict stock market trends with varying degrees of accuracy.",
    "AI can generate art and music, pushing the boundaries of creative expression.",
    "AI algorithms can analyze medical images to assist in diagnosing diseases.",
    "AI is used in agriculture to monitor crop health and optimize yields.",
    "AI can personalize learning experiences in education, adapting to individual student needs.",
    "AI is driving advancements in autonomous vehicles, aiming to reduce traffic accidents.",
    "AI can identify patterns in large datasets that are beyond human capability.",
    "AI-powered chatbots provide customer support around the clock.",
    "AI can help in climate modeling to predict future environmental changes.",
    "AI is being used in predictive maintenance to prevent equipment failures in various industries.",
    "AI can assist in legal work by analyzing documents and identifying relevant information.",
    "AI can generate deepfake videos, which are becoming increasingly difficult to distinguish from real ones.",
    "AI is being used to optimize supply chains, reducing costs and improving efficiency.",
    "AI can help in wildlife conservation by monitoring animal populations and detecting poaching activities.",
    "AI-powered recommendation systems drive content on platforms like Netflix and Spotify.",
    "AI is being used to develop personalized medicine, tailoring treatments to individual genetic profiles.",
  ];
